...
function pago(){
  let pago = prompt("¿Que metodo de pago prefiere? \n1. Efectivo \n2. Mercado Pago \n3. Crédito/Débito")
} if  (pago === 1) {
  alert ("Pagale al vendedor, rata. Muchas gracias por su compra!")
} else if (pago === 2 ){
  alert ("Pidale al vendedor el QR. Muchas gracias por su compra!")
} else if (pago === 3 ){
  alert ("Pasele la tarjeta al vendedor. Muchas gracias por su compra!")
}